...
public class GameManager {
	...
	public void AddGameEngines(List<GameEngine> engines) {
		
		this.currentGameEngine = engines.get(0);
		for (GameEngine engine : engines) {
			this.games.put(engine.GetGameId(), engine);
		}
	...
	public void ResetCurrentEngine() {
		this.currentGameEngine.ResetEngine();
	}
